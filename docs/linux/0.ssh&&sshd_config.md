...
### ssh转发
在win上 ssh连接 120.26.126.154[ats服务器] 22  
![img_1.png](img_1.png)   
发现本地ssh客户端会开启个随机端口连接到sshd  

在10.60.44.133服务器上 ssh -p3333 avatar@10.60.44.16, 在通过16主机  ssh -p3333 avatar@10.60.44.197  
流程: 133随机端口的客户端--> 16的sshd,后 16的随机端口的客户端在-->197的sshd  

ssh端口转发解决133直接访问197的问题  
